...
MAJOR_CHOICES = [
    ...
    ("Accounting_Finance_Consulting", "Accounting for Finance and Consulting"),
    ("African_Studies", "African and African Diaspora Studies"),
    ("American_Heritages", "American Heritages"),
    ("Applied_Physics", "Applied Physics"),
    ("Applied_Psychology_Human_Development", "Applied Psychology and Human Development"),
    ...
    ("Global_Public_Health", "Global Public Health and the Common Good"),
    ("History", "History"),
    ...
    ("Islamic_Civilization_Societies", "Islamic Civilization and Societies"),
    ("Italian", "Italian"),
    ...
    ("Nursing", "Nursing"),
    ("Perspectives_on_Spanish_America", "Perspectives on Spanish America"),
    ...
    ("Theatre", "Theatre"),
    ("Theology", "Theology"),
    ("Transformative_Educational_Studies", "Transformative Educational Studies"),
]

# Minor Choices
MINOR_CHOICES = [
    ("Accounting_CPAs", "Accounting for CPAs"),
    ("Accounting_Finance_Consulting", "Accounting for Finance & Consulting"),
    ("African_Studies", "African and African Diaspora Studies"),
    ...
    ("East_European_Eurasian_Studies", "East European and Eurasian Studies"),
    ("Economics", "Economics"),
    ...
    ("Hispanic_Studies", "Hispanic Studies"),
    ("History", "History"),
    ("Immigration_Education_Humanitarian_Studies", "Immigration, Education, and Humanitarian Studies"),
    ("Inclusive_Education", "Inclusive Education"),
    ("International_Studies", "International Studies"),
    ("Irish_Studies", "Irish Studies"),
    ("Islamic_Civilization_Societies", "Islamic Civilization & Societies"),
    ("Italian", "Italian"),
    ...
    ("Philosophy", "Philosophy"),
    ("Physics", "Physics"),
    ("Religion_American_Public_Life", "Religion and American Public Life"),
    ("Research_Evaluation_Measurement", "Research, Evaluation, and Measurement"),
    ("Restorative_Transformational_Justice", "Restorative and Transformational Justice"),
    ("Russian", "Russian"),
    ("Secondary_Education", "Secondary Education"),
    ("Sociology", "Sociology"),
